...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_MINS, KC_DEL,  LOWER,   KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_P7,    KC_P8,    KC_P9, KC_RPRN, KC_BSPC,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_P4,    KC_P5,    KC_P6, KC_RCBR, KC_PIPE,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_P1,    KC_P2,    KC_P3, KC_END,  _______,
    KC_EQL, _______, _______, _______, _______, _______, _______, KC_P0,    KC_MNXT,  KC_VOLD, KC_VOLU, KC_MPLY
),
